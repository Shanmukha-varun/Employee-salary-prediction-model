...
if st.button("Predict Income"):
    ...
    # Fill any potential NaN values (e.g., if a rare OHE category wasn't generated by input) with 0.
    # One-hot encoding produces 0 for non-active categories.
    processed_input_df = processed_input_df.fillna(0)
